...
# as a (multi-line) env var — MYSQL_SSL_CA_CONTENT — since most PaaS hosts
# have no built-in concept of "mount this file". We write it to disk here,
# once, at boot, and MYSQL_ATTR_SSL_CA (set separately) points Laravel's PDO
